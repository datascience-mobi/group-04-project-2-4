...
\includegraphics{Markdown_all_milestones_files/figure-latex/unnamed-chunk-11-1.pdf}
...
\includegraphics{Markdown_all_milestones_files/figure-latex/unnamed-chunk-12-1.pdf}
...
\includegraphics{Markdown_all_milestones_files/figure-latex/unnamed-chunk-13-1.pdf}
...
\includegraphics{Markdown_all_milestones_files/figure-latex/unnamed-chunk-14-1.pdf}
...
\KeywordTok{mtext}\NormalTok{(}\StringTok{"PCA of FC colored according to drug"}\NormalTok{, }
      ...
      \DataTypeTok{cex =} \FloatTok{1.12}\NormalTok{,}
...
\includegraphics{Markdown_all_milestones_files/figure-latex/unnamed-chunk-15-1.pdf}
...
\includegraphics{Markdown_all_milestones_files/figure-latex/unnamed-chunk-16-1.pdf}
...
\includegraphics{Markdown_all_milestones_files/figure-latex/unnamed-chunk-17-1.pdf}
...
\includegraphics{Markdown_all_milestones_files/figure-latex/unnamed-chunk-18-1.pdf}
...
\subsection{Table of 15 cell lines}\label{table-of-15-cell-lines}}
...
\NormalTok{cancertypes_top15 <-}\StringTok{ }\KeywordTok{sapply}\NormalTok{(}\KeywordTok{names}\NormalTok{(cell_line_var_greater_75quantile), }\ControlFlowTok{function}\NormalTok{(x) \{annotation_cancertype[}\KeywordTok{which}\NormalTok{(x }\OperatorTok{==}\StringTok{ }\KeywordTok{names}\NormalTok{(annotation_cancertype))]}
\NormalTok{\})}
\NormalTok{table_cell_lines_var_top15 <-}\StringTok{ }\KeywordTok{cbind}\NormalTok{(celllines_top15, cell_line_var_greater_75quantile, cancertypes_top15)}

\KeywordTok{colnames}\NormalTok{(table_cell_lines_var_top15) <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Cellline"}\NormalTok{, }\StringTok{"Variance"}\NormalTok{, }\StringTok{"Cancertype"}\NormalTok{)}
...
\KeywordTok{print}\NormalTok{(table_cell_lines_var_top15)}
\end{Highlighting}
\end{Shaded}
...
12      K-562  0.14258       NSCL
13     HCT-15  0.13979      Colon
14     DU-145  0.13966       NSCL
15         SR  0.13955       NSCL
\end{verbatim}
...
\KeywordTok{text}\NormalTok{(pca}\OperatorTok{$}\NormalTok{rotation[ ,}\DecValTok{1}\NormalTok{], }
\NormalTok{     pca}\OperatorTok{$}\NormalTok{rotation[ ,}\DecValTok{2}\NormalTok{], }
     \KeywordTok{colnames}\NormalTok{(e_foldchange),}
     \DataTypeTok{pos =} \DecValTok{3}\NormalTok{,}
     \DataTypeTok{cex =} \FloatTok{0.6}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{Markdown_all_milestones_files/figure-latex/unnamed-chunk-21-1.pdf}
...
\KeywordTok{EnhancedVolcano}\NormalTok{(statistics_values, }
                ...
                \DataTypeTok{pCutoff =} \FloatTok{10e-15}\NormalTok{, }\CommentTok{#threshold for coloring significant ones}
                \DataTypeTok{FCcutoff =} \DecValTok{1}\NormalTok{, }\CommentTok{#threshold for coloring high FC}
                ...
                \DataTypeTok{axisLabSize =} \DecValTok{10}\NormalTok{) }\CommentTok{# remove subtitle and caption generated by Bioconductor}
\end{Highlighting}
\end{Shaded}

\includegraphics{Markdown_all_milestones_files/figure-latex/unnamed-chunk-22-1.pdf}
...
\includegraphics{Markdown_all_milestones_files/figure-latex/unnamed-chunk-23-1.pdf}
...
\NormalTok{MA}\OperatorTok{$}\NormalTok{Significant <-}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(MA}\OperatorTok{$}\NormalTok{FDR_values}\OperatorTok{<}\FloatTok{0.05}\NormalTok{, }\StringTok{"FDR < 0.05"}\NormalTok{, }\StringTok{"Not Sig"}\NormalTok{)}

\CommentTok{#matrix with important genes of MA plot }
\NormalTok{MA_labeled <-}\StringTok{ }\NormalTok{MA[}\KeywordTok{which}\NormalTok{(MA[ , }\StringTok{"M"}\NormalTok{] }\OperatorTok{>}\StringTok{ }\FloatTok{1.5} \OperatorTok{|}\StringTok{ }\NormalTok{MA[,}\StringTok{"M"}\NormalTok{] }\OperatorTok{>}\StringTok{ }\FloatTok{0.95} \OperatorTok{&}\StringTok{ }\NormalTok{MA[,}\StringTok{"A"}\NormalTok{] }\OperatorTok{>}\StringTok{ }\DecValTok{10}\NormalTok{) , ]}
...
\StringTok{  }\KeywordTok{geom_text}\NormalTok{(}\DataTypeTok{data=}\NormalTok{MA_labeled, }\KeywordTok{aes}\NormalTok{(A, M, }\DataTypeTok{label=}\KeywordTok{rownames}\NormalTok{(MA_labeled)))}\OperatorTok{+}
\StringTok{  }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{plot.title =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size=}\DecValTok{13}\NormalTok{, }\DataTypeTok{face=}\StringTok{"bold"}\NormalTok{, }\DataTypeTok{hjust=}\FloatTok{0.5}\NormalTok{)) }\CommentTok{# change the size and face (bold) of the title and centre it (hjust=0.5)}
\end{Highlighting}
\end{Shaded}

\includegraphics{Markdown_all_milestones_files/figure-latex/unnamed-chunk-24-1.pdf}
...
\includegraphics{Markdown_all_milestones_files/figure-latex/unnamed-chunk-25-1.pdf}
...
\includegraphics{Markdown_all_milestones_files/figure-latex/unnamed-chunk-26-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# create a matrix e_treated_biomarkers/ e_untreated_biomarkers, with the gene expression only of the biomarkers}
\NormalTok{e_treated_biomarkers <-}\StringTok{ }\KeywordTok{sapply}\NormalTok{(biomarkers, }\ControlFlowTok{function}\NormalTok{(x)\{}
\NormalTok{  e_treated[x, ]}
\NormalTok{\})}
\NormalTok{e_untreated_biomarkers <-}\StringTok{ }\KeywordTok{sapply}\NormalTok{(biomarkers, }\ControlFlowTok{function}\NormalTok{(x)\{}
\NormalTok{  e_untreated[x, ]}
\NormalTok{\}) }
\KeywordTok{colnames}\NormalTok{(e_treated_biomarkers) <-}\StringTok{ }\KeywordTok{paste}\NormalTok{(}\KeywordTok{colnames}\NormalTok{(e_treated_biomarkers),}\StringTok{"Treated"}\NormalTok{,}
...
\NormalTok{e_treated_untreated_biomarkers <-}\StringTok{ }\KeywordTok{cbind}\NormalTok{ (e_treated_biomarkers, e_untreated_biomarkers)}
\NormalTok{e_treated_untreated_biomarkers <-}\StringTok{ }\NormalTok{e_treated_untreated_biomarkers[,}\KeywordTok{order}\NormalTok{(}\KeywordTok{colnames}\NormalTok{(e_treated_untreated_biomarkers))]}

\CommentTok{# create a color vector, where untreated samples are green and treated ones are red}
\NormalTok{color_boxplot_e_treated_untreated <-}\StringTok{ }\KeywordTok{sapply}\NormalTok{(}\KeywordTok{colnames}\NormalTok{(e_treated_untreated_biomarkers), }\ControlFlowTok{function}\NormalTok{(x) \{}
  \KeywordTok{ifelse}\NormalTok{(x }\OperatorTok{%in%}\StringTok{ }\KeywordTok{grep}\NormalTok{ (}\StringTok{"Treated"}\NormalTok{,}\KeywordTok{colnames}\NormalTok{(e_treated_untreated_biomarkers), }\DataTypeTok{value =} \OtherTok{TRUE}\NormalTok{),}
...
\KeywordTok{boxplot}\NormalTok{(e_treated_untreated_biomarkers, }\DataTypeTok{ylab=} \StringTok{"gene expression (log2)"}\NormalTok{, }
        \DataTypeTok{main=} \StringTok{"Boxplot of gene expression of the biomarkers"}\NormalTok{, }\DataTypeTok{cex =} \FloatTok{1.12}\NormalTok{, }\DataTypeTok{las=}\DecValTok{2}\NormalTok{, }\DataTypeTok{col=}\NormalTok{ color_boxplot_e_treated_untreated)}
\end{Highlighting}
\end{Shaded}

\includegraphics{Markdown_all_milestones_files/figure-latex/unnamed-chunk-27-1.pdf}
...
\includegraphics{Markdown_all_milestones_files/figure-latex/figEGR1 -1.pdf}
...
\includegraphics{Markdown_all_milestones_files/figure-latex/unnamed-chunk-30-1.pdf}
...
\includegraphics{Markdown_all_milestones_files/figure-latex/unnamed-chunk-34-1.pdf}
...
\includegraphics{Markdown_all_milestones_files/figure-latex/unnamed-chunk-34-2.pdf}
...
\includegraphics{Markdown_all_milestones_files/figure-latex/unnamed-chunk-37-1.pdf}
...
\includegraphics{Markdown_all_milestones_files/figure-latex/unnamed-chunk-39-1.pdf}
...
\includegraphics{Markdown_all_milestones_files/figure-latex/unnamed-chunk-39-2.pdf}
...
\includegraphics{Markdown_all_milestones_files/figure-latex/unnamed-chunk-41-1.pdf}
