...
EnhancedVolcano(statistics_values, 
                ...
                #subtitle = "",
                #caption = ""
                ) # remove subtitle and caption generated by Bioconductor
...
boxplot(foldchange_biomarkers, ylab= "foldchange", 
        main= "Boxplot of foldchange of the biomarkers", cex = 1.2, las=2)
```
...
par(mar = c(8, 2, 2, 2))
boxplot(e_treated_untreated_biomarkers, 
...
venn.plot <- venn.diagram(
  ...
  filename = NULL, 
  fill = c("blue", "red"), 
  main = "Venn Diagramm of most correlating genes", 
  main.fontface = 2,
  main.cex = 1.2,
  main.fontfamily = "sans", # font type of title is Arial 
  cat.fontfamily = "sans",
...
#for all genes , biomarkers
```{r}
correlation_allgenes <- apply (e_foldchange, 1,lm(LogGI50_59_celllines ~ e_foldchange [1,]) )
#https://stackoverflow.com/questions/51736905/dplyrrename-at-gives-error-must-evaluate-to-column-positions-or-names
