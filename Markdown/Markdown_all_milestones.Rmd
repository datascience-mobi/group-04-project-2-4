...
annotation_cancertype <- as.data.frame(annotation_cancertype)
#Scaling of pathways
...
pheatmap(t(heatmap_data),
         ...
         annotation_col = annotation_cancertype,
...
cellline_clusters <- as.data.frame(cbind(cellline_groups, annotation_cancertype))
