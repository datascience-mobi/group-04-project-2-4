...
biomarkers_volcano <- rownames(statistics_values)[which(abs(statistics_values[, 1]) > 1 
...
cor_top_100_genes <- cor_all_genes_sorted[1:100]

cor_biomarkers <- sapply(biomarkers, function(x){
...
venn.plot <- venn.diagram(
  x = list(
    "100 genes with highest correlation" = names(cor_top_100_genes),
