...
EnhancedVolcano(statistics_values, 
                ...
                titleLabSize = 13,
                pCutoff = 10e-10, #threshold for coloring significant ones
                FCcutoff = 0.5, #threshold for coloring high FC
...
biomarkers_volcano <- rownames(statistics_values)[which(abs(statistics_values[, 1]) > 0.5 
                                                   & statistics_values[, 2] < 10e-10)]
biomarkers <- rownames(statistics_values)[which(abs(statistics_values[, 1]) > 0.5)]
