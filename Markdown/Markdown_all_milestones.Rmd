...
ERCC6L is essential for the accurate segregation of sister chromatids during mitosis and therefore is essential for cytokinesis and cell proliferation. This protein binds to double-stranded DNA and cut the ultra-fine DNA bridges between the sister chromatids if stretching force is exposed by the mitotic spindle. (https://www.genecards.org/cgi-bin/carddisp.pl?gene=DLEU2&keywords=dleu2)

ATAD2 is part of the AAA (ATPases Associated with diverse cellular Activities) family. It performs on the one hand chaperone-like-functions like the assembly and degradation of protein complexes. On the other hand, it is associated with chromatin binding and histone binding. Therefore, it is part of the "Gastric Cancer Network 2" and "Transcriptional regulation by the AP-2 (TFAP2) family of transcription factors" which both include EGFR as a central protein. (https://www.genecards.org/cgi-bin/carddisp.pl?gene=ATAD2)

E2F8 is a transcription factor and plays a role in various processes for example angiogenesis and polyploidization of specialized cells. E2F8 is a transcription repressor and suppresses the expression of E2F1 which is a component in the feedback loop in S phase. When E2F8 is downregulated more E2F1 is transcription and in case of DNA damage p53/TP53-dependent apoptosis is initiated. E2F8 plays a key role in polyploidization of cells, by repressing genes which promote cytokinesis. Furthermore, it activates the transcription of angiogenesis allied genes.
(https://www.genecards.org/cgi-bin/carddisp.pl?gene=E2F8&keywords=e2f8)

MKI67 is a nuclear protein and is associated with cellular proliferation. MKI67 is therefore used as a proliferation marker in human cells. IT has a high electrical charge and binds to the DNA. The electrical charge prevents the chromosomes from the formation of one giant chromatin mass and therefore enables independent chromosome motility.
(https://www.genecards.org/cgi-bin/carddisp.pl?gene=MKI67&keywords=mki67)

Mikro RNAs like MKI67 are involved in post-transcriptional regulation of gene expression. Binding of miRNAs affects both the stability and the translation of mRNA and therefore regulates the biosynthesis of proteins. MIR15A is an important tumor suppressor gene cluster and a reduction of MIR15A is related to progression of tumors. Furthermore, it plays a role in many different biological processes like tumor cell proliferation, invasion, chemoresistance and apoptosis. 
(https://www.genecards.org/cgi-bin/carddisp.pl?gene=MIR15A&keywords=mir15a)
...
In addition to that we want to compare our results with **Lapatinib**, which is also a tyrosine kinase inhibitor like Erlotinib. Lapatinib is used for the treatment of patients with metastatic breast cancer whose tumors overexpress HER2. Because both drugs target the epidermal growth factor receptor, we suggest that this drug could have the same effect on our found biomarkers. 

First of all we have to prepare and normalize the Lapatinib data like we done it with Erlotinib.
...
When we compare the biomarker ERCC6L after Erlotinb show equal results on the renal cell lines CAKI-1. Beside that ERCC6L is not regulated in the ovarian cell line IGR-OV1 and the NSCL cancer cell line NCI-H332M.  
