...
```{r }
plot(density(NCI_TPW_gep_untreated), "Density plot of gene expression", cex.main = 1.12)
...
EnhancedVolcano(statistics_values, 
                ...
                legendLabSize= 10,
                axisLabSize = 10,
                subtitle = "", caption = "") # remove subtitle and caption generated by Bioconductor
...
plot(density(e_treated[biomarkers, ]), "Density plot of gene expression", cex = 1.12, col = "red")
