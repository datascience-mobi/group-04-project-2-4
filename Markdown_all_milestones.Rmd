...
# WENN DER ANDERE LÄUFT ENTFERNEN !!!!!!
par(oma = c(10, 1, 1, 1))
...
In this milestone we want to identify celllines which are highly affected by Erlotinib treatment. This effect could be seen in a change of RNA expression and therfore a change in for example cell growth and proliferation pathways and also metabilism.
...
EnhancedVolcano(statistics_values, 
                ...
                legendLabSize= 10,
                axisLabSize = 10 
                # subtitle = "")  remove subtitle generated by Bioconductor
                 )
```
...
biomarkers_volcano <- rownames(statistics_values)[which(abs(statistics_values[, 1]) > 0.25 
                                                   & statistics_values[, 2] < 10e-9)]
